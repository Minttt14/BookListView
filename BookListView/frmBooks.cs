...
namespace BookListView
{
    ...
    {
        string[] b_name = { "三國演義", "西遊記", "唐詩三百首", "楚辭", "西廂記", "水滸傳", "紅樓夢", "牡丹亭", "儒林外史", "史記", "竇娥冤", "老殘遊記" }; //書名
        string[] author = {"羅貫中", "吳承恩", "孫洙", "劉向", "王實甫", "施耐庵", "曹雪芹", "湯顯祖", "吳敬梓", "司馬遷", "關漢卿", "劉鶚" }; //作者
        string[] kind = { "章回小說", "章回小說", "詩選", "詩歌", "戲曲", "章回小說", "章回小說", "戲曲", "章回小說", "史書", "戲曲", "章回小說" }; //類別
        public frmBooks()
        {
            InitializeComponent();
        }
